...
Inverse-transform: (for -1 <= x <= 1, 0 otherwise):

![Inverse-transform](hw3a.png)

Composition: I think that line 2 above, cutting the domain in half and doubling the output was an example of compostion. (http://web.ics.purdue.edu/~hwan/IE680/Lectures/Chap08Slides.pdf)
